    ...
    <div style={{ background: 'var(--bg-main)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 20px' }} className="animate-fade-in">
        ...
        <div style={{
          ...
          <h4 style={{ color: 'var(--primary-blue)', marginTop: '25px', marginBottom: '10px', fontWeight: 800 }}>Our Academic Vision</h4>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }} className="services-grid">
          {list.map((s, idx) => (
            <div key={idx} style={{
              ...
              <h3 style={{ fontSize: '1.3rem', fontWeight: 800, marginBottom: '10px', color: 'var(--primary-blue)' }}>{s.title}</h3>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 20px', display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '40px' }} className="contact-grid animate-fade-in">
        <div style={{ textAlign: 'left' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            <div>
              <strong style={{ color: 'var(--primary-blue)', display: 'block', fontWeight: 800 }}>HQ Location</strong>
              <span style={{ color: 'var(--text-secondary)' }}>Mombasa Road Corporate Center, Nairobi, Kenya</span>
            </div>
            <div>
              <strong style={{ color: 'var(--primary-blue)', display: 'block', fontWeight: 800 }}>Email Support</strong>
              <span style={{ color: 'var(--text-secondary)' }}>ops@smooth.co.ke</span>
            </div>
            <div>
              <strong style={{ color: 'var(--primary-blue)', display: 'block', fontWeight: 800 }}>Hotline</strong>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--primary-blue)', marginBottom: '20px' }}>Send a Message</h3>
